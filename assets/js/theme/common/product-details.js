...
export default class ProductDetails extends ProductDetailsBase {
    constructor($scope, context, productAttributesData = {}) {
        ...
        if (hotStockNoOptions) {
            ...
            this.hotStock(inventoryQuantity);
        }
        ...
        $.each($('[data-product-attribute]'), (index, value) => {
            ...
            if (type === 'set-rectangle' || type === 'set-radio' || type === 'swatch' || type === 'input-checkbox' || type === 'product-list') {
                ...
                if (checked) {
                    ...
                    if (type === 'swatch') {
                        const label = isBrowserIE ? getSelectedOptionLabel().children[0].innerText.trim() : checked.labels[0].children[0].innerText;
                        if (label) {
    ...
    addProductToCart(event, form) {
        ...
        utils.api.cart.itemAdd(normalizeFormData(new FormData(form)), (err, response) => {
            ...
            // Open sidebar cart and update content
